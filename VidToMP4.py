...
print("Welcome to video converter, which converts videos to MP4. ")
...
root.withdraw()
clip = moviepy.VideoFileClip(filedialog.askopenfilename(title='Choose video file'))
print("Are you sure to convert?")
input('Press ENTER/RETURN to continue')
clip.write_videofile(filedialog.asksaveasfilename(filetypes=[("MP4 video","*.mp4")], defaultextension = "*.mp4"))
print("Done.")
